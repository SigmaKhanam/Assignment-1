...
age = 70  # Age of the person
is_resident = True  # Residency status (True for resident, False for non-resident)
...
weather = "sunny"  # Weather condition (e.g., "sunny", "cloudy", "snowy")
