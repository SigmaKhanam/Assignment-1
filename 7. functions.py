...
def calculate_factorial(n):
    ...
    Returns:
    int: The factorial of the number, or None if an error occurs.
    """
    try:
...
print(calculate_factorial(-3))  # Error: Input must be a non-negative integer.
print(calculate_factorial("a"))  # Error: Input must be an integer.
