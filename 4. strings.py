...
# Biodata string
biodata = "Name: Jeena, Age: 23, Country: Bangladesh"

# Extracting information using string methods
name = biodata.split(", ")[0].split(": ")[1]
age = biodata.split(", ")[1].split(": ")[1]
country = biodata.split(", ")[2].split(": ")[1]
...
# Write your code below:
# Using a dictionary to store person's information
person_info = {
    "name": "Jeena",
    "age": 23,
    "country": "Bangladesh"
...
# Example usage
string = "Assalamualikum Warahmatullahi Wabarakatuhu"
counts = char_count(string)
